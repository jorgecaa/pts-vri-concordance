#!/usr/bin/env python3
"""reid_sn3.py — re-identifica cada fila de S iii por NOMBRE+PÁGINA y detecta `Sutta #` erróneos.
...
parte del volumen, pero **falso en varios saṃyuttas**: ahí el Excel salta los grupos peyyāla y su
...
Uso:
    python3 reid_sn3.py            # informe
    python3 reid_sn3.py --write    # corrige el `Sutta #` de las filas con doble evidencia
"""
...
def main():
    ...
    print('=' * 96)
    print('RE-IDENTIFICACIÓN DE S iii POR NOMBRE+PÁGINA')
    print('=' * 96)
    ...
    bak = f'{XLSX}.backup-{datetime.datetime.now():%Y%m%d-%H%M%S}-sn3reid.xlsx'
